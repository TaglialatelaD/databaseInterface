...
public class RemoveExamFrame extends JDialog {
	private JTextField textFieldCE;

	public RemoveExamFrame(Controller ctrl) {
		...
		JLabel lblTitle = new JLabel("Remove an exam");
		...
		btnRemove.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				if(ctrl.removeExam(textFieldCE.getText())){
					lblResponse.setForeground(Color.GREEN);
					lblResponse.setText("Exam successfully removed.");
				}else {
					lblResponse.setForeground(Color.RED);
					lblResponse.setText("Error occured while removing the exam.");
				}
		...
		textFieldCE.setBackground(null);
		textFieldCE.setFont(new Font("Berlin Sans FB Demi", Font.PLAIN, 17));
