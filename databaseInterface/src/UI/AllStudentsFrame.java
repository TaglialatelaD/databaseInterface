...
public class AllStudentsFrame extends JDialog{
	private JTable table;
	
	public AllStudentsFrame(Controller ctrl) {
		...
		JLabel lblTitle = new JLabel("Students list");
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Matricola", "First Name", "Last Name", "Exam Cod.", "Vote"
			}
		));
